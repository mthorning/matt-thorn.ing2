...
```
I've used a closure here, if you're not clued up on closures then you should check out my post about them [here](/posts/using-closure). Next, we'll recreate the functions from above:
```jsx
const testCases = {
...
Hopefully you found this post useful, thanks for taking the time to read to the end. If you have any comments, corrections or questions then you can contact me on Twitter.
